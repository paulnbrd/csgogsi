...
def on_new_round():  # If the server observed a change to the payload subattribute round_no (of the attribute
    # played_map), it will call this function
    print("The server observed a change to the payload ! We are now in the round {} !".format(
        server.payload.played_map.round_no))
